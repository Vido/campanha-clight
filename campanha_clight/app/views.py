...
def __getType(palavra):
    ...
    if palavra == "impulsiva":
        ...
        texto= "<p>Uau, hoje você está em total sintonia com seu corpo. Uma rotina tranquila e sem pressa vai te beneficiar bastante.</p><p>O destaque é para a saúde: boa alimentação combinada com seu esporte preferido ou yoga já produzem aquela higiene mental e energética que você adora.</p>"
